...
namespace air
{
    ...
    // 创建采样器
    void VkUIPipeline::createSamper(VkRenderDriver &driver)
    {
    ...
    void VkUIPipeline::createPipelineLayout(VkRenderDriver &driver)
    {
        ...
        VkDescriptorSetLayout set_layout[1] = {mDescLayout};
    ...
    void VkUIPipeline::createShaderModule(VkRenderDriver &driver)
    {
    ...
    {
        // 创建着色器
        createShaderModule(driver);

        VkPipelineShaderStageCreateInfo stage[2] = {};
        stage[0].sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        stage[0].stage = VK_SHADER_STAGE_VERTEX_BIT;
        stage[0].module = mVertShader;
        stage[0].pName = "main";
        stage[1].sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        stage[1].stage = VK_SHADER_STAGE_FRAGMENT_BIT;
        stage[1].module = mFragShader;
        stage[1].pName = "main";

        VkVertexInputBindingDescription binding_desc[1] = {};
        binding_desc[0].stride = sizeof(UIVectex);
        ...
        attribute_desc[0].offset = offsetof(UIVectex, mPos);
        attribute_desc[1].location = 1;
        attribute_desc[1].binding = binding_desc[0].binding;
        attribute_desc[1].format = VK_FORMAT_R32G32_SFLOAT;
        attribute_desc[1].offset = offsetof(UIVectex, mUVW);
        attribute_desc[2].location = 2;
        attribute_desc[2].binding = binding_desc[0].binding;
        attribute_desc[2].format = VK_FORMAT_R8G8B8A8_UNORM;
        attribute_desc[2].offset = offsetof(UIVectex, mClr);
        ...
        dynamic_state.dynamicStateCount = (uint32_t)array_size(dynamic_states, VkPipelineDynamicStateCreateInfo);
        dynamic_state.pDynamicStates = dynamic_states;

        creatDescLayout(driver);
        createPipelineLayout(driver);
